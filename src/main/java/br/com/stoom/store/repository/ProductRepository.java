...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    public List<Product> findListProductByBrandId(@Param("brandId") Long brandId);
    ...
    public List<Product> findListProductByCategoryId(@Param("categoryId") Long categoryId);
}